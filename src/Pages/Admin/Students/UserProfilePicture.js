...
const UserProfilePicture = (props) => {
  ...
  const { valueStudentPicture, valueFirstname, valueStudentname } =
    useContext(LoginContext);
  const [studentname, setStudentname] = valueStudentname;
  const [studentPicture, setStudentPicture] = valueStudentPicture;
    ...
    <>
      ...
      <div className="profile-info">
        ...
        <div className="profile-picture">
          <img src={studentPicture} alt="Profile picture" />
        </div>
